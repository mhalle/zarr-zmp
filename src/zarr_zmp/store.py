...
def default_zmp_mount_opener(
    ...
    *,
    ...
    # Inline mount via _path — data stored in a sibling manifest entry.
    # This lets the child ZMP have its own path, checksum, and metadata,
    # and be referenced by multiple mounts or inspected independently.
